...
function getRow(patients) {
  const rowItems = patients.map((patient) =>
    <tr onClick = {() => clientClick(patient)}>
      ...
      <p className = "Tab"></p>
      <td className = "Completion">Completed {getCompleted(patient.assignments)}/{patient.assignments.length} homework assignments</td>
      <p className = "Tab"></p>
        ...
        <Col>
          <div className = "border">
            <div className = "Profile-info">
              ...
              <Row className= "Name-Row justify-content-md-center">
                <Card className = "Next-Session-Date">{patient.nextSession}</Card>
              </Row>
              <Row className = "Name-Row justify-content-md-center">
